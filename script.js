...
function createThemeChangeEffect() {
    const accentColor = getComputedStyle(document.body).getPropertyValue('--accent-rgb').trim() || '110, 231, 216';
    ...
    effect.style.background = `radial-gradient(circle, rgba(${accentColor}, 0.24) 0%, transparent 70%)`;
